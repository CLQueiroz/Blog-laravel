...
<pagina tamanho="12">
    ...
    <painel titulo="Lista de Autores">
        ...
        <tabela-lista v-bind:titulos="['ID', 'Nome', 'E-mail']" v-bind:itens="{{json_encode($listaModelo)}}" ordem="desc" ordemcol="1" criar="#criar" detalhe="/admin/autores/" editar="/admin/autores/" modal="sim">
        </tabela-lista>
        <div align="center">
            {{$listaModelo}}
        </div>
